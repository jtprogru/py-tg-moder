...
- **Веб-панель** — дашборд аналитики (участники, сообщения, капча, действия модерации, журнал с причинами) на том же процессе, что и бот. Вход через Telegram Login Widget, доступ по списку `admin_ids`.

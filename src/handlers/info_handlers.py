...
_ADMIN_HELP = (
    ...
    "\nЦель команды — это ответ на сообщение, либо @username или числовой id.\n\n"
    "• /ban [срок] — забанить (напр. /ban @user 1d)\n"
    "• /unban — разбанить\n"
    "• /kick — удалить из чата (может вернуться)\n"
    "• /mute [срок] — замьютить (напр. /mute @user 30m)\n"
    "• /unmute — снять мьют\n"
    "• /warn [причина] — предупредить\n"
    "• /warns — история предупреждений\n"
